...
> ✅ **One wallet. One human. Verified on-chain.** This is what makes bot swarms and multi-wallet farms structurally impossible for verified participants — the entire point of 1Edge.
...
1. **Pass the humanity check.** Verification is a quick set of challenges — a Cloudflare Turnstile check plus a few interactive puzzles. **No social account required** — you don't connect X or anything else.

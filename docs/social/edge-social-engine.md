...
# The Edge <span class="g">Social Engine</span>
...
A platform-wide feed where verified humans post takes, share launches, and follow each other. Because every account is backed by [on-chain-verified performance](verified-metrics.md), the feed surfaces real traders rather than anonymous hype accounts.
...
The thing that makes Edge Social different from a generic chat bolt-on is what sits underneath it: every participant is a [verified human](../index.md) with a [provable track record](verified-metrics.md). That's what turns social activity into actual signal.

...
* **Build a reputation that compounds.** Your verified history is an asset — it travels with your profile across [Edge Social](edge-social-engine.md) and feeds [leaderboards](../rewards/tier-matrix.md).
* **Cut the scams.** When PnL can't be faked, the screenshot-grifters have nothing to sell.

## Related

* [Profiles & Handles](profiles-and-identity.md) — where these stats live.
* [The Edge Social Engine](edge-social-engine.md) — discovery built on verified reputation.
